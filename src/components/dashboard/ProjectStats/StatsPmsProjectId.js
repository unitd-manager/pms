...
export default function StatsPmsProjectId({
  ...
  useEffect(() => {
    if (id) {
      api.post('/stats/getStatsEmployeeId', { employee_id: selectedEmployeeId, project_id: id })
        .then((res) => {
          setData(res.data.data);
        })
        .catch(() => {});
      
      api.post('/stats/getStatsId', { employee_id: selectedEmployeeId, project_id: id })
        .then((res) => {
